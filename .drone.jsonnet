...
[
  ...
  pipeline.build(name, 'v5.11', '5.11', 'amd64'),
  pipeline.build(name, 'v5.11', '5.11', 'arm32v7'),
  pipeline.build(name, 'v5.11', '5.11', 'arm64v8'),
  pipeline.manifest('v5.11', '5.11', ['amd64', 'arm32v7', 'arm64v8']),
  ...
  pipeline.microbadger(['latest', '5.11', '5.10', '5.6']),
]
